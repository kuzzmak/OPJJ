...
<title>Uredi objavu</title>
</head>

<body>
	
	<div class="container">
	  <form action="editBlogEntry?blogId=${blogId}" method="post">
	  
	    <label for="blogTitle">Title</label>
	    <input type="text" id="blogTitle" name="blogTitle" value="${blogTitle}">
	
	    <label for="text">Tekst objave</label>
	    <textarea id="text" name="text" style="height:200px">${blogText}</textarea>
